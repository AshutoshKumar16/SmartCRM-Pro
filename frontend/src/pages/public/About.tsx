...
export default function About() {
  ...
  const team = [
    { name: 'Ashutosh Sinha', role: 'CEO & Founder', init: 'AS' },
    { name: 'Shivam Singh', role: 'CTO & Co-founder', init: 'SS' },
    { name: 'Atul Gupta', role: 'Head of Product', init: 'AG' },
    { name: 'Vishal Yadav', role: 'Head of Sales', init: 'VY' },
  ]
